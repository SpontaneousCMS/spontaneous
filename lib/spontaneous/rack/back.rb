...
module Spontaneous
  module Rack
    module Back
      ...
      JAVASCRIPT_FILES = %w(vendor/jquery-1.5.1.min vendor/jquery-ui-1.8.9.custom.min vendor/JS.Class-2.1.5/min/core extensions spontaneous properties dom popover popover_view ajax types image content entry page_entry box page field field_types/string_field field_types/file_field field_types/image_field field_types/markdown_field field_types/date_field content_area preview editing location state top_bar field_preview box_container progress status_bar upload_manager dialogue edit_dialogue edit_panel add_home_dialogue page_browser add_alias_dialogue publish init load)
