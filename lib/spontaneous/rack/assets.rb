  ...
  module Rack
    module Assets
      ...
      module JavaScript
        ...
        EDITING_JS = %w(vendor/jquery-ui-1.8.16.custom.min vendor/JS.Class-2.1.5/min/core vendor/crypto-2.3.0-crypto vendor/crypto-2.3.0-sha1 vendor/diff_match_patch extensions spontaneous properties dom authentication user popover popover_view ajax event_source types image content views views/box_view views/page_view views/piece_view views/page_piece_view entry page_entry box page field field_types/string_field field_types/file_field field_types/image_field field_types/markdown_field field_types/date_field field_types/webvideo_field content_area preview editing location state top_bar field_preview box_container progress status_bar upload sharded_upload upload_manager dialogue edit_panel add_home_dialogue page_browser add_alias_dialogue conflicted_field_dialogue  publish init load)
      end
